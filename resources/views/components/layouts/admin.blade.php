                        ...
                        <ul class="flex flex-col space-y-1">
                            ...
                            <li>
                                <a href="{{ route('admin.users.index') }}"
                                    ...
                                    <i class='bx bx-user text-xl text-gray-700 me-3 me-3'></i>
                                    Users
                                </a>
                            </li>
                            ...
                            <li x-data="{ open: false }">
                                <button @click="open = !open"
                                    ...
                                    <div class="flex items-center">
                                        <i class='bx bx-calendar text-xl text-gray-700 me-3 me-3'></i>
                                        <span>Schedule</span>
                                    </div>
                                ...
                                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                    ...
                                    x-transition:leave-end="transform opacity-0 scale-95" class="pl-10 mt-2 space-y-2">
