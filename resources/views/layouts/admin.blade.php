        ...
        <div class="fixed top-4 bottom-4 left-6 w-72 bg-white text-gray-800 shadow-lg rounded-lg z-10">
            ...
            <nav class="flex-1 mt-3 px-4 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('admin.schedules') }}"
                    class="@if (request()->routeIs('admin.schedules')) bg-gray-200 @endif flex font-medium flex-row items-center px-4 py-2 rounded hover:bg-gray-100">
                    <i class='bx bx-user text-2xl text-orange-400 me-5'></i>Schedule</a>
                <a href="#" class="flex font-medium flex-row items-center px-4 py-2 rounded hover:bg-gray-100"><i
