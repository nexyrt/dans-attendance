<div>
    ...
    <x-layouts.admin>
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
            ...
            <div
                class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-lg border border-gray-200 dark:border-gray-700 p-4 
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="text-xs font-medium text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/30 px-2.5 py-0.5 rounded-full
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <div class="max-h-60 overflow-auto">
                                <div class="relative py-2 px-4">
                                    <div class="space-y-1">
                                        <template x-for="type in ['sick', 'annual', 'important', 'other']"
                                            :key="type">
                                            <label
                    ...
                    <div class="relative">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <div class="max-h-60 overflow-auto">
                                <div class="relative py-2 px-4">
                                    <div class="space-y-1">
                                        <template x-for="status in ['pending', 'approved', 'rejected']"
                                            :key="status">
                                            <label
                                                class="relative flex items-center p-2 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700/50 cursor-pointer">
                                                <input type="checkbox" :checked="selected.includes(status)"
                                                    @change="
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="relative" x-data="{ open: false }">
                                        ...
                                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                            ...
                                            <!-- Status Change -->
                                            <div class="py-1">
                                                <button wire:click="changeStatus({{ $request->id }})"
                                                    @click="open = false"
                                                    ...
                                                    @if ($request->status === 'pending') text-yellow-500 dark:text-yellow-400
                                                    @elseif($request->status === 'approved')
                                                        text-green-500 dark:text-green-400
                                                    @else
                                                        text-red-500 dark:text-red-400 @endif"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12">
                                    <div class="flex flex-col items-center justify-center text-center">
                                        ...
                                        <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No records
                                            found
                                        </h3>
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ ucfirst($selectedRequest->status) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="relative w-full max-w-xl transform rounded-2xl bg-white dark:bg-gray-800 shadow-2xl transition-all"
                                        ...
                                        @if ($createForm['approved_by'])
                                            @php
                                                $selectedManager = $managers
                                                    ->where('id', $createForm['approved_by'])
                                                    ->first();
                                            @endphp
                                            <div class="flex items-center">
                                                <div
                                        ...
                                        @forelse($managers as $manager)
                                            <template
                                                ...
                                                <button type="button"
                                                    ...
                                                    :class="{ 'bg-blue-50 dark:bg-blue-900/50': {{ $createForm['approved_by'] }} ==
                                                            {{ $manager->id }} }">
                                                    <!-- Avatar/Initial -->
                                                    <div
                                                        class="flex-shrink-0 h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-600 flex items-center justify-center">
                ...
                <div class="flex items-center justify-end gap-3 border-t border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <button type="submit" wire:click="createRequest"
                        class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                        <svg wire:loading wire:target="createRequest"
    ...
    <div x-data="{ show: false, requestId: null }" @open-delete-modal.window="show = true; requestId = $event.detail.id" x-show="show"
    ...
    <div>
        ...
        <!-- Reject Modal -->
        @if ($showRejectModal)
            <div class="fixed inset-0 bg-black/25 backdrop-blur-sm z-50 flex items-center justify-center p-4" x-data
