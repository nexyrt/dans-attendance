            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left">
                            <span class="text-xs font-medium text-gray-500 uppercase tracking-wider">Late Tolerance (min)</span>
                        </th>
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:text-left">
                        ...
                        <form wire:submit="save" class="mt-4 space-y-4">
                            ...
                            <div>
                                ...
                                <select wire:model="day_of_week" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <input type="time" wire:model="end_time" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <input type="number" wire:model="late_tolerance" min="0" max="120" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                @error('late_tolerance') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                            </div>
